...
function AccountDropdown() {
    ...
    return (
        <div className="relative">
            <button onClick={() => setShowDropdown(!showDropdown)} className="block h-8 w-8 rounded-full overflow-hidden border-2 border-gray-600 focus:border-white focus:outline-none">
